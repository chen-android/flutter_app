...
class _ListWordsState extends State<ListWords> {
  ...
  void _pushSaved() {
    Navigator.of(context)
      ...
      final Iterable<ListTile> tile = _saved.map((e) => ListTile(
            title: Text(
              e.asPascalCase,
              style: _biggerFont,
            ),
          ));
      final List<Widget> divided = ListTile.divideTiles(context: context,tiles: tile).toList();
      return Scaffold(
